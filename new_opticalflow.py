...
def _main():
    ...
    #image_flow = cv2.calcOpticalFlowPyrLK(image2_gray, image1_gray, None, 0.5, 3, 15, 3, 5, 1.2, 0)
    image_flow = cv2.calcOpticalFlowPyrLK(image2_gray, image1_gray, None)
    ...
    pred_flow = cv2.calcOpticalFlowPyrLK(pred_image_flow, pred2_gray, None, 0.5, 3, 15, 3, 5, 1.2, 0)
